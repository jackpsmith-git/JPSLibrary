...
public static class ASCII
{
    ...
    public static byte[] Encode(string data) => System.Text.Encoding.ASCII.GetBytes(data);
    ...
    public static string Decode(byte[] data) => System.Text.Encoding.ASCII.GetString(data);
}